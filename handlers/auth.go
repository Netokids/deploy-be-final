...
import (
	authdto "BE-finaltask/dto/auth"
	dto "BE-finaltask/dto/result"
	"BE-finaltask/models"
	"BE-finaltask/pkg/bcrypt"
	jwtToken "BE-finaltask/pkg/jwt"
...
func (h *handlerAuth) RegisterDoctor(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
...
func convertResponseRegister(u models.User) authdto.RegisterRespons {
	return authdto.RegisterRespons{
		Email:    u.Email,
		Password: u.Password,
	}
}
